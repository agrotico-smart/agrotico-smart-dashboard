  ...
  try {
    ...
    return {
      ...
      climate: climateCurrent[0] ? {
        temperatura_2m: parseFloat(climateCurrent[0].temperatura_2m || "0"),
        temperatura_maxima: parseFloat(climateCurrent[0].temperatura_maxima || "0"),
        temperatura_minima: parseFloat(climateCurrent[0].temperatura_minima || "0"),
        ...
        precipitacion_corregida: parseFloat(climateCurrent[0].precipitacion_corregida || "0"),
        humedad_relativa: parseFloat(climateCurrent[0].humedad_relativa || "0"),
        humedad_especifica: parseFloat(climateCurrent[0].humedad_especifica || "0"),
        velocidad_viento: parseFloat(climateCurrent[0].velocidad_viento || "0"),
        velocidad_viento_max: parseFloat(climateCurrent[0].velocidad_viento_max || "0"),
        velocidad_viento_min: parseFloat(climateCurrent[0].velocidad_viento_min || "0"),
        radiacion_onda_larga: parseFloat(climateCurrent[0].radiacion_onda_larga || "0"),
        radiacion_onda_corta: parseFloat(climateCurrent[0].radiacion_onda_corta || "0"),
        ...
        presion_superficie: parseFloat(climateCurrent[0].presion_superficie || "0"),
        evaporacion: parseFloat(climateCurrent[0].evaporacion || "0"),
      } : null,
    };
  } catch (error) {
